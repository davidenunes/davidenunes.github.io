...
Recently, services like [GitHub](https://github.com) made git particularly
popular, but the convenience of Github has its downsides for new users: it
...
You could make a backup of your repository by creating a mirror folder and
archiving it.
